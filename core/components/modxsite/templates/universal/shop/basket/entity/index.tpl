...
<div data-smodx-basket="minibasket" class="basket" xmlns="http://www.w3.org/1999/html">
    <a href="[[~82]]">{*Корзина*}
            ...
            {if $basket_result.success && $basket_result.object}
                <div class="">
                    <span class="title-cart">
                        ...
                        <span class="text">{$total|spell:"товар":"товара":"товаров"}</span>
                        <span style="white-space:nowrap;">
                            <span class="cost">{$sum|number_format:0:".":" "}</span>
